...
/**
 * Demonstrates the Open/Closed Principle using the Strategy pattern for
 * discounts.
 * <p>
 * Each customer‐type class implements {@link DiscountStrategy} and therefore
 * can be added
 * without changing the surrounding calculation code. The {@code @Override}
 * annotations
